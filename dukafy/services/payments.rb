...
class Payments
  ...
  class << self
    def start(order:, provider_slug:, params: {})
      found = Dukafy::Plugins.payment_provider(provider_slug)
      ...
      Dukafy::Plugins.emit(:payment_initiated, attempt)
    ...
    def settle(attempt, result)
      ...
      if result.amount_cents && result.amount_cents != attempt.amount_cents
        ...
        Dukafy::Plugins.emit(:payment_failed, attempt)
        return attempt
      end
      ...
      when :succeeded
        ...
        Dukafy::Plugins.emit(:payment_succeeded, attempt)
      when :failed
    ...
    def refresh(attempt)
      ...
      found = Dukafy::Plugins.payment_provider(attempt.provider)
