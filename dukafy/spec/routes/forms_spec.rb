...
# Merchant-defined forms: the merchant invents the fields, Dukafy stores what
...
class FormsSpec < Minitest::Test
  ...
  def test_a_merchant_defined_form_stores_whatever_fields_it_declared
    ...
    # Fields Dukafy has never heard of — an emergency contact form.
    post "/forms/contact", contact_name: "Ada", contact_phone: "+254712345678",
                           relationship: "sister"

    assert_equal 200, last_response.status, last_response.body
    assert_equal "dukafy:form-submitted", last_response.headers.fetch("hx-trigger")
  ...
  def test_the_signed_timestamp_is_rendered_into_cms_forms
    html = Dukafy::Publisher::REGISTRY.fetch("base.form").render(
