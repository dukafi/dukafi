...
//
// `window.__dukafiAuthed` is set by `server/static.ts` ONLY when the request
...
if (typeof window !== 'undefined' && (window as unknown as { __dukafiAuthed?: number }).__dukafiAuthed === 1) {
