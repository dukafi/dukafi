...
export const SANDBOX_MESSAGE_SOURCE = 'dukafi-module-sandbox'
export const HOST_MESSAGE_SOURCE = 'dukafi-module-host'
...
<html lang="en">
  <head>
    ...
    <style id="dukafi-class-styles">${escapeStyleContent(classCSS)}</style>
  </head>
  <body>
    <div id="root"></div>
    <script type="module">
      ...
      const classStyleEl = document.getElementById('dukafi-class-styles');
      ...
      function showError(error) {
        ...
        pre.className = 'dukafi-runtime-error';
