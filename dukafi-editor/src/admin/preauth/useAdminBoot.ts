 ...
 * `window.__dukafiBootPromises`. When present, this hook consumes them instead
...
function readPreflightedBootPromises(): PreflightedBootPromises | null {
  ...
  const candidate = (window as unknown as { __dukafiBootPromises?: unknown }).__dukafiBootPromises
