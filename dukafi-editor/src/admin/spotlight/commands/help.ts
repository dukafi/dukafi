...
export function getHelpCommands(): Command[] {
  return [
...

    {
      ...
      run: (ctx) => {
        ctx.closeSpotlight()
        window.open('https://github.com/corebunch/dukafi/blob/main/docs/', '_blank', 'noopener,noreferrer')
      },
    },

    {
      ...
      run: (ctx) => {
        ctx.closeSpotlight()
        window.open('https://github.com/corebunch/dukafi/issues/new', '_blank', 'noopener,noreferrer')
      },
    },

    {
      ...
      run: (ctx) => {
        ...
        window.open('https://github.com/corebunch/dukafi', '_blank', 'noopener,noreferrer')
      },
    },
