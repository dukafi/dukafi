...
const LOOP_SOURCE = /^(?:products|collections|reviews|orders|paymentProviders|cart\.items|data\/[a-z0-9-]+|(?:currentEntry|parentEntry)\.[a-zA-Z]+|(?:products|collections)\/[a-z0-9-]+\.[a-zA-Z]+)$/
