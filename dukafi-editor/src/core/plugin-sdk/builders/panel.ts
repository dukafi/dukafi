 ...
 *
 *   import { definePluginPanel } from '@dukafi/plugin-sdk'
 *   import { Stack, Button, Card, Text } from '@dukafi/host-ui'
 ...
 * build time, `dukafi-plugin build` externalizes `react`, `react/jsx-runtime`,
 * `@dukafi/host-ui`, `@dukafi/host-hooks`, and
 * `@dukafi/plugin-sdk`. The host's import map resolves those names at
 ...
 * errors surface during `dukafi-plugin build`, not at editor activation.
 */
