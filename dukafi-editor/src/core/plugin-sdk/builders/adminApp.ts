 ...
 *
 *   import { definePluginAdminApp } from '@dukafi/plugin-sdk'
 *   import { Stack, Heading, Button, Card, Text } from '@dukafi/host-ui'
 ...
 *   • `@dukafi/host-ui` for design-system primitives (Button, Stack, …).
 *   • `@dukafi/host-hooks` for editor / settings / routes hooks.
 *
