 ...
 * dynamic (must be deferred to request time via a `<dukafi-hole>` placeholder).
 ...
 * ids needing `<dukafi-hole>` placeholders AND the human-readable reason
 ...
 * `<dukafi-hole>` placeholder. Empty set means the page is fully static.
 *
