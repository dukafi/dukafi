...
const PREVIEW_LINK_PREFIX = 'dukafi-font-preview-'
const PREVIEW_VARIANTS_LINK_PREFIX = 'dukafi-font-preview-variants-'
...
export function loadFontPreview(family: string): void {
  ...
  link.setAttribute('data-source', 'dukafi-font-preview')
...
export function loadFontPreviewWithVariants(family: string, variants: readonly string[]): void {
  ...
  link.setAttribute('data-source', 'dukafi-font-preview-variants')
  document.head.appendChild(link)
}
