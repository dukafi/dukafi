 ...
 * `data-dukafi-readonly-*` markers on every element of the region.
 */
...
interface ReadOnlyNodeTreeProps {
   ...
   * `data-dukafi-readonly-*` markers identifying its editable source, so the
...
/** Build the `data-dukafi-readonly-*` marker bag spread onto read-only nodes. */
function readonlyMarkers(region: ReadOnlyRegion | undefined): NodeWrapperPropsType | undefined {
  if (!region) return undefined
  return {
    'data-dukafi-readonly-label': region.label,
    'data-dukafi-readonly-kind': region.kind,
    'data-dukafi-readonly-id': region.targetId,
  }
}
