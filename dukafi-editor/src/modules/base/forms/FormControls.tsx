...
export function FormEditor({ children, mcClassName, nodeWrapperProps, props }: ModuleComponentProps<FormProps>) {
  ...
  return (
    <form
      ...
      data-dukafi-form-editor-preview={previewState !== 'default' ? previewState : undefined}
      data-dukafi-form-state={runtimeState !== 'default' ? runtimeState : undefined}
...
export function FormMessageEditor({ mcClassName, nodeWrapperProps, props }: ModuleComponentProps<FormMessageProps>) {
  ...
  return (
    <div
      {...nodeWrapperProps}
      className={mcClassName}
      data-dukafi-form-message={props.kind}
      data-dukafi-form-id={normalizeIdentifierValue(props.formId)}
      data-dukafi-form-preview-active={previewActive ? 'true' : undefined}
