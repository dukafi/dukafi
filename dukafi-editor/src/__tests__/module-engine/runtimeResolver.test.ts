...
const SITE_IMPORTMAP: RuntimePackageImportmap = {
  ...
  imports: {
    three: '/_dukafi/runtime/cache/abc123def456ghi789jkl012/three/build/three.module.js',
    'three/': '/_dukafi/runtime/cache/abc123def456ghi789jkl012/three/',
    typescript: '/_dukafi/runtime/cache/abc123def456ghi789jkl012/typescript/lib/typescript.js',
  },
}
...
describe('runtime dependency resolver', () => {
  it('looks up a single package URL in the site importmap', () => {
    ...
    ).toBe('/_dukafi/runtime/cache/abc123def456ghi789jkl012/three/build/three.module.js')
  })
  ...
  it('builds an import map filtered to the module declared deps', () => {
    ...
    expect(importMap.imports.three).toBe(
      '/_dukafi/runtime/cache/abc123def456ghi789jkl012/three/build/three.module.js',
    )
    expect(importMap.imports['three/']).toBe(
      '/_dukafi/runtime/cache/abc123def456ghi789jkl012/three/',
    )
