/**
 * Shared test fixture factories for the Dukafi test suite.
 *
 * Design goals:
...
export function makePage(overrides: Partial<Page> = {}): Page {
  ...
  return {
    ...
    ...(overrides.seoTitle !== undefined ? { seoTitle: overrides.seoTitle } : {}),
    ...(overrides.seoDescription !== undefined ? { seoDescription: overrides.seoDescription } : {}),
