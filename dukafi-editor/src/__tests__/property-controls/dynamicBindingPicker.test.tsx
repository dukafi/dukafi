...
const mockCommerceProducts = {
  products: [
    {
      id: 1, title: 'Canvas Tote', slug: 'canvas-tote', vendor: 'Dukafi', status: 'active',
...
describe('DynamicBindingControl picker', () => {
  ...
  it('still shows commerce fields when the generic data-meta endpoint does not exist (real Dukafi has no data_tables system)', async () => {
    // Dukafi never implements the Instatic-era `/data/_meta` route — this
