      ...
      packageImportmap: {
        ...
        imports: Object.fromEntries(
          Object.keys(packageDeps).flatMap((name) => [
            [name, `/_dukafi/runtime/cache/test-hash/${name}/index.js`],
            [`${name}/`, `/_dukafi/runtime/cache/test-hash/${name}/`],
          ]),
        ),
      },
    })
...
describe('ModuleSandboxFrame — missing dependency empty state', () => {
  ...
  // surface — Dukafi has no resolver behind it (`runtimeAssets: { scripts: [] }`).
