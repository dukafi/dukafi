...
export function CanvasModulePlaceholder({
  ...
  return (
    <div
      ...
      data-layout={layout}
    >
      <div className={styles.content} data-dukafi-placeholder-content="">
        {icon ? (
          <span
            className={styles.icon}
            data-dukafi-placeholder-icon=""
            aria-hidden="true"
          >
            {icon}
          </span>
        ) : null}
        <span className={styles.label} data-dukafi-placeholder-label="">{label}</span>
        {variant === 'block' && description ? (
          <span className={styles.description} data-dukafi-placeholder-description="">{description}</span>
        ) : null}
        {variant === 'block' && actions ? (
          ...
          <div
            ...
            data-dukafi-placeholder-actions=""
