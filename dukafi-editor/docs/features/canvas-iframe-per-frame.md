...
`EditorChromeInjector` uses **stable `data-*` attribute selectors** (`data-canvas-module-placeholder`, `data-dukafi-slot-instance`, etc.) — not hashed CSS Module class names which only exist in the parent document.
