...
The primary-column width is persisted to `localStorage` via `usePrimaryColumnWidth.ts` (key: `dukafi-data-grid-primary-widths-v1`).
...
- [docs/reference/persistence-keys.md](../reference/persistence-keys.md) — `dukafi-data-grid-primary-widths-v1`
