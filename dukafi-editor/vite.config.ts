...
// shell (for some other project — nothing in Dukafi's own tooling sets
// PORT) silently pointed /uploads, /_dukafi, and the large-body/
...
function publicSiteDevProxyPlugin(): Plugin {
  return {
    name: 'dukafi-public-site-dev-proxy',
    apply: 'serve',
...
function largeBodyDevProxyPlugin(): Plugin {
  return {
    name: 'dukafi-large-body-dev-proxy',
    apply: 'serve',
