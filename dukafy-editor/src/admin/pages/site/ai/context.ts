 ...
 *
 * The one thing the prompt MUST teach is the part of Dukafy that has no HTML
...
export const SYSTEM_PROMPT = `You edit a page in Dukafy, a self-hosted store builder.
